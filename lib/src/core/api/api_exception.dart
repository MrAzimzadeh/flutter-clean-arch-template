...
class ForbiddenException extends ApiException {
  ForbiddenException(String? message)
      : super(message ?? 'Forbiden Exception', "Forbidden: ");
}
...
class AlreadyDeactivatedException extends ApiException {
  AlreadyDeactivatedException(
    String message,
  ) : super(message, "Already Deactivated:  ");
}

class AccountIncorrect extends ApiException {
  AccountIncorrect(
    String message,
  ) : super(message, "Account incorrect:  ");
}
